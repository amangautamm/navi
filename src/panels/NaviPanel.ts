...
export class NaviPanel {
  public static currentPanel: NaviPanel | undefined;
  private readonly _panel: vscode.WebviewPanel;
  private _disposables: vscode.Disposable[] = [];
  private _resolve: ((value: ProjectConfig | undefined) => void) | undefined;

  public static async show(extensionUri: vscode.Uri): Promise<ProjectConfig | undefined> {
  ...
  private constructor(
    ...
    resolve: (value: ProjectConfig | undefined) => void
  ) {
    this._panel = panel;
    ...
    this._panel.webview.onDidReceiveMessage(
      (message) => {
        if (message.command === 'submit') {
          this._resolve?.(message.config as ProjectConfig);
          this.dispose();
